    ...
    @if (visible()) {
      ...
      >
        ...
        <div class="flex flex-col items-center gap-6">
          <div class="relative">
            <div class="w-16 h-16 border-2 border-[#EF4444] rounded-full animate-spin border-t-transparent"></div>
            <div class="absolute inset-0 flex items-center justify-center">
              <svg class="w-8 h-8 text-[#EF4444]" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div class="text-center">
            <p class="text-[#EF4444] font-black text-3xl tracking-tight uppercase">APEX</p>
