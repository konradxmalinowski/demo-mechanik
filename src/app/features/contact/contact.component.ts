  ...
  template: `
    <div class="min-h-screen bg-white text-mechanik-noir dark:bg-mechanik-noir dark:text-white pt-24 pb-16">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p class="text-gray-600 dark:text-gray-400 mb-12">Skontaktuj się z nami lub odwiedź nasz warsztat.</p>
          ...
          <div class="space-y-6">
            <div class="bg-gray-50 dark:bg-mechanik-surface border border-black/5 dark:border-white/5 rounded-xl p-6">
              ...
              <dl class="space-y-3 text-sm">
                ...
                <div class="flex gap-3"><dt class="text-gray-600 dark:text-gray-500 w-20">E-mail</dt><dd>kontakt&#64;apex-mechanik.pl</dd></div>
                <div class="flex gap-3"><dt class="text-gray-600 dark:text-gray-500 w-20">Pon–Pt</dt><dd>08:00 – 18:00</dd></div>
                <div class="flex gap-3"><dt class="text-gray-600 dark:text-gray-500 w-20">Sobota</dt><dd>09:00 – 14:00</dd></div>
              </dl>
            </div>
          </div>
